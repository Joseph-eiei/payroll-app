                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                  ...
                  <div>
                   ...
                   <div>
                    ...
                    <input type="date" lang="en" name="start_date" id="start_date" value={formData.start_date} onChange={handleFormChange} className="text-gray-900 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm p-2" />
                  </div>
                  <div>
